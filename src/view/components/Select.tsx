    ...
    <div>
      <div className='relative'>
        ...
        <RdxSelect.Root onValueChange={handleSelect} value={value}>
          ...
          <RdxSelect.Portal>
            <RdxSelect.Content className="z-[99] overflow-hidden bg-white rounded-2xl border border-gray-100 shadow-sm">
              ...
              <RdxSelect.Viewport className="p-2">
                {options.map((option) => (
                  <RdxSelect.Item
                    ...
                    value={option.value}
                    className={cn(
                      'p-2 text-gray-800 text-sm data-[state=checked]:font-bold outline-none data-[highlighted]:bg-gray-100 rounded-2xl transition-colors',
                    )}
